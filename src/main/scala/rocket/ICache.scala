...
class ICacheModule(outer: ICache) extends LazyModuleImp(outer)
  ...
  when (refill_done) {
    ...
    // @todo should cover refillError rather than corrupt.
    //       TileLink spec: d_corrupt being HIGH indicates that masked data in this beat is corrupt.
